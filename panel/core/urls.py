...
urlpatterns = [
    ...
    path('diako/qr-background/', v.qr_background_view, name='diako_qr_background'),
    ...
    path('diako/api/qr-background/', api_views.qr_background_image, name='diako_qr_background_image'),
    path('diako/api/qr-background/upload/', api_views.qr_background_upload, name='diako_qr_background_upload'),
    path('diako/api/qr/preset/<str:key>/', api_views.qr_preset_image, name='diako_qr_preset_image'),
    path('diako/api/qr/config/', api_views.qr_config, name='diako_qr_config'),
    path('diako/api/qr/reset/', api_views.qr_reset, name='diako_qr_reset'),
    path('diako/api/qr/render/', api_views.qr_render, name='diako_qr_render'),
    path('diako/api/qr/preview-bg/', api_views.qr_preview_bg, name='diako_qr_preview_bg'),
    path('diako/api/qr/layer/', api_views.qr_layer, name='diako_qr_layer'),
    ...
    path('diako/api/panel-settings-action/', api_views.panel_settings_action, name='diako_panel_settings_action'),
