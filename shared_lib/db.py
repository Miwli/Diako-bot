...
_DEFAULT_TEXTS: dict[str, str] = {
    ...
    "ticket_already_closed":      "این تیکت قبلاً بسته شده.",
    # ─── آموزش‌ها ────────────────────────────────────────────────────────
    ...
    "proforma_discount_text":  "🧾 <b>پیش‌فاکتور</b>\n────────────────────────\n📦 <b>پلن:</b> {plan_name}\n📊 <b>حجم:</b> {traffic} گیگابایت\n📅 <b>مدت:</b> {duration} روز\n────────────────────────\n💰 قیمت اصلی: <s>{original}</s> تومان\n🎟 تخفیف کد <code>{code}</code>: {discount} تومان\n✅ <b>مبلغ نهایی: {final} تومان</b>{balance_line}",
